<template>
  <div class="change_pass_page kz_card">
    ...
    <div class="card_body fcc">
      ...
      <el-form :model="telForm" :rules="telRules" ref="telFormRef" size="large" hide-required-asterisk v-show="setLv === 1">
        ...
        <el-form-item label="验证码" prop="yzm">
          <div class="fcs f1">
            ...
            <el-button class="bdc_btn" @click="getSms" :disabled="smsTime > 0">{{smsTime === 0 ? '获取验证码': smsTime + 'S后重新获取'}}</el-button>
          </div>
        </el-form-item>
        <el-form-item>
      ...
      <el-form :model="passForm" :rules="rules" ref="passFormRef" size="large" hide-required-asterisk v-show="setLv === 2" label-width="70px">
        <el-form-item label="原密码" prop="oldPass">
          <el-input v-model="passForm.oldPass" placeholder="请输入原密码" style="width:320px" show-password></el-input>
        </el-form-item>
        <el-form-item label="新密码" prop="pass">
          <el-input v-model="passForm.pass" placeholder="请输入新密码" style="width:320px" show-password></el-input>
        </el-form-item>
        <div class="tips">* 密码最小长度6个字，最大长度18个字；<br/>必须包含: 小写字母、数字</div>
        <el-form-item label="确认密码" prop="checkPass">
          <el-input v-model="passForm.checkPass" placeholder="请再次输入新密码" style="width:320px" show-password></el-input>
        </el-form-item>
        <el-form-item>
