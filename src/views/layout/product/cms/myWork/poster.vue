<template>
  <div class="m_poster">
    ...
    <el-dialog v-model="addShow" title="上传海报" width="400px" @close="close" custom-class="upimgs">
      <div v-loading="loading" class="add_img_content">
        <KzImgUpload
          ...
          :msg="'宽高比：16:9，建议尺寸：640x1136px、800*2000px、1242px*1242px，支持'+exnameList.join('、')+'等图片格式'"
          ref="upload"
        />
...
import { posterList_api, posterAdd_api, posterDel_api, posterEdit_api } from '@/api/product/cms/myWork'
