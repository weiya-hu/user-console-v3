  ...
  <div class="kz_card dmp_page">
    ...
    <div class="dmp_table">
      <el-table v-loading="loading" :data="tableList" size="large">
        ...
        <el-table-column property="group_name" label="渠道名称" width="200">
          <template #default="{ row }">
            <el-tooltip effect="dark" placement="top">
              <template #content>
        ...
        <el-table-column property="group_desc" label="渠道描述" width="300">
          <template #default="{ row }">
            <el-tooltip effect="dark" placement="top">
              <template #content>
                <div style="width: 100px" class="fcc">{{ row.group_name }}</div>
    ...
    >
      <div>
        ...
        >
          ...
          <el-form-item label="渠道名称" required prop="name">
            <el-input v-model="formValue.name" placeholder="请输入渠道名称" clearable></el-input>
          </el-form-item>
          <el-form-item label="渠道描述" required prop="desc">
            <el-input
