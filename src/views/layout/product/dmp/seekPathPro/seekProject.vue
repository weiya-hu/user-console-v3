  ...
  <div class="kz_card my_up2c_page">
    ...
    <div class="mytable">
      ...
      >
        ...
        <el-table-column property="type" label="行业分类">
        ...
        <el-table-column property="group_name" label="项目名称" />
        <el-table-column property="group_desc" label="项目描述" />
