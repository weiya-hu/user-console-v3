<template>
  <div class="kz_card baidudata_page_c dmp_page">
    ...
    <KzPeopleTable
      :data="tableData"
      details="/product/dmp/findc/biddingDataDetails"
      @select="selectTable"
      @del="sureDel"
    />
...
import { addBidding_api, getBiddingList_api, delBidding_api } from '@/api/product/dmp/findC'
...
const sureDel = (id: string) => {
  delBidding_api({ id }).then((res: any) => {
...
<script lang="ts">
export default { name: 'BiddingData' }
</script>
